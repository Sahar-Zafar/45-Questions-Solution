...
function headingPart(solutionNumber: string): void {
  ...
  console.log(
    chalk.bold.italic.hex('#001').bgYellowBright(
...
headingPart(
  ("Welcome to 45 Questions Solution!")
);
...
let famous_Person: string =  "\nAlbert Einstein";
let famous_quote: string = `${famous_Person} once said: \n"${famousQuote}" `;
...
const names: string[] = ["Ayesha","Sadaf","Zarnam","Sidra"];
...
let message1: string = "Are you interested in learning TypeScript?";
...
let transportation: string[] = ["Honda Motorcycle", "Audi", "Ferrari"];
...
let guests_Li: string[] = ["Sahar", "Ayesha", "Maryam"];
...
console.log(
  "I have a great news! I get a big table. Therefore, I am inviting  three more peoples.\n"
);
...
let languages: string[] = ["Urdu", "Arabic", "Chinese", "French", "English"];
console.log("\nList of languages:\n", languages);
...
//Programs that creating objects containing information
interface person {
  name: string;
  gender: string;
  age: number;
...
console.log("inequality test with numbers: ", (10 as number) != 5);
...
const fruits: string[] = ["Melon", "Pineapple", "Banana"];
//Item is in an array
console.log('Testing "Melon" in the array: ', fruits.includes("Melon"));
//Item is not in an array
console.log(
  'Testing "Custard Apple" in not in an array: ',
  !fruits.includes("custard Apple"),
  "\n"
);
...
let favFruits: string[] = ["Strawberry", "Custard Apple", "Kiwi"];
...
const userName: string[] = ["Admin", "Aleesha", "Sana", "Kiran", "Aqsa"];
...
let userNames: string[] = ["Admin", "Alishba", "Mahanoor", "Laiba"];
//list is empty.
...
let currentUsers: string[] = ["ADmin", "AliShba", "MaHanoor", "LaiBa", "John"];

let newUsers: string[] = ["ADmin", "Fatima", "AliShba", "Zainab", "Fariya"];

newUsers.forEach((newUsername) => {
  let lowerCase: string = newUsername.toLowerCase();
  if (currentUsers.map((c_user) => c_user.toLowerCase()).includes(lowerCase)) {
    console.log(
      `\nThe username ${newUsername} is not available. Kindly write another username`
...
const album1: Album = makeAlbum("Artist 1", "Album Title 1");
const album2: Album = makeAlbum("Artist 2", "Album Title 2", 12); //number of tracks provided
const album3: Album = makeAlbum("Artist 3", "Album Title 3", 8); //number of tracks provided
...
let magician: string[] = ["Harry Houdini", "David Copperfield", "Criss Angel"];
...
let magician1: string[] = ["Harry Houdini", "David Copperfield", "Criss Angel"];

function make_great(magician1Array: string[]) {
...
let magician2: string[] = ["Harry Houdini", "David Copperfield", "Criss Angel"];

function copyArray(arr: string[]) {
  return [...arr];
}

function make_great2(magician2Array: string[]) {
...
const carInfo = storeCarInfo(
  "Honda",
  "Civic",
  { colour: "Black" },
  { features: ["Navigation", "Power_window"] }
);
console.log(carInfo, "\n\n");
